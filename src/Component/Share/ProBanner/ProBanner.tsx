...
const ProBanner = ({ headline, description, buttonText, image }:SectionContent) => {
  return (
    <section className="relative z-10 w-full py-6 sm:py-8 md:py-12 lg:py-16 flex justify-center items-center bg-gradient-to-br from-[#06101A] via-[#06101A] to-[#06101A]   container mx-auto">
      {/* Decorative Images: hero1 left, hero2 right, icon bottom right */}

      <img
        src="/contact.png"
        alt="Decorative Icon"
        className="pointer-events-none select-none absolute -right-1 bottom-0 sm:-right-4 sm:bottom-2 md:-right-5 md:bottom-4 h-16 sm:h-24 md:h-36 lg:h-36 xl:h-36 w-auto opacity-40 sm:opacity-70 z-0"
        aria-hidden="true"
      />
      <div className="container w-[95%] relative mx-auto px-2 sm:px-4 flex flex-col md:flex-row items-center bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl p-4 sm:p-6 md:p-10 lg:p-12 z-10">
        <img
          src="/hero1.png"
          alt="Decorative Left"
