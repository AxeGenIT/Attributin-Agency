...
const logos: Logo[] = [
  ...
  { id: 8, name: "DMA Partner", path: "/brands/dma_client.webp" },
    ...
    return (
      ...
      <div className="relative -mt-32 h-96 w-screen overflow-hidden [mask-image:radial-gradient(50%_50%,white,transparent)] before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_bottom_center,#07dde8,transparent_70%)] before:opacity-40 after:absolute after:top-1/2 after:-left-1/2 after:aspect-[1/0.7] after:w-[200%] after:rounded-[100%] after:border-t after:border-[#05e6f2] after:bg-zinc-900">
        <SparklesCore
          id="tsparticles"
