...
// ✅ Custom Hook for Counter Animation with TypeScript
const useCounter = (
  end: number,
          ...
          >
            ...
            <div className="relative z-10 flex flex-col justify-end h-full">
              <div className="self-start">
                <div className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-bold text-white mb-2">
        ...
        <div className="flex flex-col lg:flex-row gap-4 sm:gap-6 mt-4 sm:mt-6 lg:items-stretch">
          ...
          >
            ...
            <div className="relative z-10 flex flex-col sm:flex-row items-start sm:items-center justify-between h-full">
              <div className="mb-4 sm:mb-0">
                <div className="text-lg sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-1 sm:mb-2">
                  {awardCount}+
                </div>
                <div className="text-white/70 text-xs sm:text-sm md:text-base lg:text-lg">
                  Award Winning
                </div>
              </div>
            </div>
