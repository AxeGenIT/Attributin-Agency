...
const ContactSection: React.FC = () => {
  ...
  const CALENDLY_URL =
    process.env.NEXT_PUBLIC_CALENDLY_URL || 'https://calendly.com/attributionbooster/30min';
  ...
  const contactInfo: ContactInfo[] = [
    { icon: '/process/location.svg', title: 'Location', details: '123 Business Ave, Suite 100, New York, NY 10001', color: 'from-gray-50 to-gray-100' },
    { icon: '/process/email.svg', title: 'Email Address', details: 'info@attributionbooster.com', color: 'from-gray-50 to-gray-100', link: 'mailto:info@attributionbooster.com' },
    { icon: '/process/phone.svg', title: 'Phone Number', details: '+8801812526073', color: 'from-gray-50 to-gray-100', link: 'tel:+8801812526073' },
    { icon: '/process/hour.svg', title: 'Working Hours', details: 'Monday - Friday | 9am - 6pm EST', color: 'from-gray-50 to-gray-100' }
  ];
  ...
  const contactItemVariants :Variants = { hidden: { opacity: 0, x: -20 }, visible: { opacity: 1, x: 0, transition: { duration: 0.5, ease: 'easeOut' } } };
  const formItemVariants :Variants = { hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { duration: 0.5, ease: 'easeOut' } } };
