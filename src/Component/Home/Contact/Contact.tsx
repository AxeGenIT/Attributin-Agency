...
const ContactSection: React.FC = () => {
  ...
  const CALENDLY_URL =
    ...
    "https://calendly.com/attributionbooster/30min";
              ...
              <motion.div variants={itemVariants}>
                <div className="">
                  ...
                  <p className="text-lg text-white/70 leading-relaxed">
                    Get in touch with us to learn how we can help you scale and
                    grow through our comprehensive digital transformation
                    services.
                  </p>
                </div>
                <div className="py-6">
                    ...
                    return (
                      ...
                      >
                        <div className="flex items-center space-x-4">
                          <div
                            className={`w-12 h-12 border-gray-50 border-opacity-50 border rounded-full flex items-center justify-center`}
                          >
                            <img
                              src={info.icon}
                              alt={info.title}
                ...
                <div className="mt-8">
                  <div className="relative overflow-hidden rounded-2xl border border-gray-50 border-opacity-30  bg-white/5 backdrop-blur-md p-6 sm:p-8">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                      <div className="flex-1 group bg-linear-to-r from-slate-800/60 to-slate-900/60 border border-white/10 rounded-xl p-5 sm:p-6 flex items-center gap-4 shadow-lg">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  <motion.div variants={formItemVariants}>
                    ...
                    <input
                      ...
                      className={`w-full px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 ${
                        errors.name
                  ...
                  <motion.div variants={formItemVariants}>
                    ...
                    <select
                      ...
                      onChange={handleInputChange}
                      className={`appearance-none w-full px-4 py-3 bg-white/10 border rounded-lg text-white focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 ${
                        errors.service
                          ? "border-red-400 focus:ring-red-400"
                          : "border-white/20 focus:ring-cyan-400"
                      }`}
                    >
                      <option value="" className="text-black bg-[#09d0d3]">
                        Select a service
                      </option>
                      <option className="text-black bg-[#09d0d3]">
                  ...
                  <motion.div variants={formItemVariants}>
                    ...
                    <textarea
                      ...
                      onChange={handleInputChange}
                      rows={4}
                      className={`w-full px-4 py-3 bg-white/10 border rounded-lg text-white placeholder-white/50 focus:outline-none focus:ring-2 focus:border-transparent transition-all duration-300 resize-none ${
                        errors.message
                          ? "border-red-400 focus:ring-red-400"
                          : "border-white/20 focus:ring-cyan-400"
                      }`}
                  ...
                  <div
                    ...
                    className={`inline-flex items-center pl-4 pr-1 py-1 rounded-full font-semibold transition-all duration-300 shadow-lg text-base ${
                      isSubmitting
                        ? "bg-gray-500 cursor-not-allowed text-white"
