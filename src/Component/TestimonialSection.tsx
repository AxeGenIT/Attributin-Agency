...
const TestimonialsSection = () => {
  ...
  const slides = Array.from(
    ...
    (_, i) => testimonials.slice(i * testimonialsPerSlide, (i + 1) * testimonialsPerSlide)
  );
      ...
      <div className="container mx-auto relative z-20 bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl shadow-2xl p-6 md:p-12">
        <div className="absolute inset-0">
          <img
            ...
            className="absolute left-0 top-0 object-cover opacity-30 h-24 sm:h-32 md:h-48 lg:h-64 xl:h-72 w-auto"
            style={{ borderTopLeftRadius: '30px' }}
          />
          <img
            src="/hero2.png"
            alt="Background Element Right"
            className="absolute right-0 top-0 object-cover opacity-30 h-24 sm:h-32 md:h-48 lg:h-64 xl:h-72 w-auto"
        ...
        <div className="relative overflow-hidden">
          ...
          <Swiper
            ...
            onSwiper={(swiper) => (swiperRef.current = swiper)} // ✅ Type-safe assignment
            className="mb-8"
          >
            ...
            {slides.map((_, dotIdx) => (
              <button
                ...
                onClick={() => {
                  ...
                  swiperRef.current?.slideTo(dotIdx); // ✅ Safe call
                }}
